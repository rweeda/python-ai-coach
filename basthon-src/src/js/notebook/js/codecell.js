...
define([
  ...
  CodeCell.prototype.create_element = function () {
    ...
    var input_area = $("<div/>")
      .addClass("input_area")
      .attr("aria-label", i18n.msg._("Edit code here"));
  ...
  CodeCell.prototype.handle_codemirror_keyevent = function (editor, event) {
    ...
    return Cell.prototype.handle_codemirror_keyevent.apply(this, [
      editor,
      event,
    ]);
  };
    ...
    return {
      ...
      iopub: {
        ...
        clear_output: function () {
          that.events.trigger("set_dirty.Notebook", { value: true });
          that.output_area.handle_clear_output.apply(
            that.output_area,
            arguments,
          );
        },
  ...
  CodeCell.prototype.set_input_prompt = function (number) {
    ...
    var prompt_html = CodeCell.input_prompt_function(
