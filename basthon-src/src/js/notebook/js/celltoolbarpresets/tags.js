...
define([
  ...
  "base/js/dialog",
  "base/js/i18n",
], function ($, celltoolbar, IPython, dialog, i18n) {
  "use strict";
  ...
  var add_tag_edit = function (div, cell, on_add, on_remove) {
    ...
    var input_container = $("<span/>").addClass("tags-input");
    add_dialog_button(input_container, cell, on_add, on_remove);
    button_container.append(input_container.append(text).append(button));
  ...
  var tag_dialog = function (cell, on_add, on_remove) {
    ...
    var dialogform = $("<div/>")
      .attr("title", i18n.msg._("Edit the tags"))
      .append(
        $("<form/>").append(
          $("<fieldset/>")
            .append($("<label/>").attr("for", "tags").text(message))
            .append($("<br/>"))
            .append(textarea)
        )
      );
  ...
  var add_tags_cellbar = function (div, cell) {
    ...
    var tag_container = $("<span/>").addClass("tag-container");
