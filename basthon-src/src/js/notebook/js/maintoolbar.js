...
define(["jquery", "./toolbar", "./celltoolbar", "base/js/i18n"], function (
  $,
  toolbar,
  celltoolbar,
  i18n,
  ...
  MainToolBar.prototype._make = function () {
    var grps = [
      ...
      [["jupyter-notebook:insert-cell-below"], "insert_above_below"],
      [
        [
      ...
      [
        ["jupyter-notebook:move-cell-up", "jupyter-notebook:move-cell-down"],
        "move_up_down",
      ],
      [
        [
      ...
      [["jupyter-notebook:toggle-fullscreen"], "toggle-fullscreen"],
    ];
    this.construct(grps);

    // fullscreen machinerie
    const updateFSIcon = () => {
      const element = document.querySelector(
        '[data-jupyter-action="jupyter-notebook:toggle-fullscreen"] i',
      );
  ...
  MainToolBar.prototype._pseudo_actions.add_celltype_list = function () {
    ...
    var sel = $("<select/>")
      ...
      .append(
        $("<option/>").attr("value", "markdown").text(i18n.msg._("Markdown")),
      )
      .append(
        $("<option/>").attr("value", "raw").text(i18n.msg._("Raw NBConvert")),
      )
      .append(
        $("<option/>").attr("value", "heading").text(i18n.msg._("Heading")),
      )
      .append(multiselect);
