...
define([
  ...
  function copy(event) {
    ...
    var selecn = Jupyter.notebook.get_selected_cells().map(function (c) {
      return c.toJSON();
    });
  ...
  function setup_paste_dialog() {
    ...
    var action = {
      ...
      handler: function () {
        ...
        var dialog_body = $("<div/>")
          .append("<p>")
          .append(
            i18n.msg.sprintf(i18n.msg._("Press %s again to paste"), cmdtrl),
          )
          .append("<br/>")
          .append("<p><b>")
          ...
          .append(
            i18n.msg._("There's an invisible text box focused in this dialog."),
          )
    ...
    var full_action_name = Jupyter.notebook.keyboard_manager.actions.register(
      action,
      "paste-dialog",
      "system-clipboard",
    );
